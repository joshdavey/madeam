...
class Madeam {
  ...
  public static $pathToSystem       = false;
  ...
  public static function paths($publicDirectory) {
    ...
    // set path to madeam
    self::$pathToSystem   = self::$pathToProject . 'system' . DS;

    // set path to vendor
    self::$pathToMadeam   = dirname(__FILE__) . DS . 'Madeam' . DS;
    
    // return paths for include path
    return array(self::$pathToApp, self::$pathToSystem, self::$pathToMadeam . 'Helper' . DS, self::$pathToLib);
  }
